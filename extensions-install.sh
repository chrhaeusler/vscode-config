...
code --install-extension blackboxapp.blackboxagent@3.2.92
code --install-extension charliermarsh.ruff@2025.22.0
code --install-extension christian-kohler.path-intellisense@2.10.0
code --install-extension docker.docker@0.8.1
...
code --install-extension ms-python.python@2025.6.1
code --install-extension ms-python.vscode-pylance@2025.5.1
code --install-extension ms-toolsai.jupyter@2025.4.1
...
code --install-extension ms-vscode-remote.remote-containers@0.413.0
code --install-extension njpwerner.autodocstring@0.6.1
code --install-extension pkief.material-icon-theme@5.23.0
